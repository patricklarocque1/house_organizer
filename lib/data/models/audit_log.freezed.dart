...
mixin _$AuditLog {
 ...
 String get id; String get userId; String get houseId; AuditAction get action; String get targetType; String get targetId; DateTime get timestamp; Map<String, dynamic>? get metadata; String? get description; String? get userDisplayName;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,houseId,action,targetType,targetId,timestamp,const DeepCollectionEquality().hash(metadata),description,userDisplayName);
...
@useResult
$Res call({
 String id, String userId, String houseId, AuditAction action, String targetType, String targetId, DateTime timestamp, Map<String, dynamic>? metadata, String? description, String? userDisplayName
});
...
/// Create a copy of AuditLog
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? houseId = null,Object? action = null,Object? targetType = null,Object? targetId = null,Object? timestamp = null,Object? metadata = freezed,Object? description = freezed,Object? userDisplayName = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String userId,  String houseId,  AuditAction action,  String targetType,  String targetId,  DateTime timestamp,  Map<String, dynamic>? metadata,  String? description,  String? userDisplayName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuditLog() when $default != null:
return $default(_that.id,_that.userId,_that.houseId,_that.action,_that.targetType,_that.targetId,_that.timestamp,_that.metadata,_that.description,_that.userDisplayName);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String userId,  String houseId,  AuditAction action,  String targetType,  String targetId,  DateTime timestamp,  Map<String, dynamic>? metadata,  String? description,  String? userDisplayName)  $default,) {final _that = this;
switch (_that) {
case _AuditLog():
return $default(_that.id,_that.userId,_that.houseId,_that.action,_that.targetType,_that.targetId,_that.timestamp,_that.metadata,_that.description,_that.userDisplayName);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String userId,  String houseId,  AuditAction action,  String targetType,  String targetId,  DateTime timestamp,  Map<String, dynamic>? metadata,  String? description,  String? userDisplayName)?  $default,) {final _that = this;
switch (_that) {
case _AuditLog() when $default != null:
return $default(_that.id,_that.userId,_that.houseId,_that.action,_that.targetType,_that.targetId,_that.timestamp,_that.metadata,_that.description,_that.userDisplayName);case _:
  return null;
...
class _AuditLog implements AuditLog {
  const _AuditLog({required this.id, required this.userId, required this.houseId, required this.action, required this.targetType, required this.targetId, required this.timestamp, final  Map<String, dynamic>? metadata, this.description, this.userDisplayName}): _metadata = metadata;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,houseId,action,targetType,targetId,timestamp,const DeepCollectionEquality().hash(_metadata),description,userDisplayName);
...
/// Create a copy of AuditLog
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = null,Object? houseId = null,Object? action = null,Object? targetType = null,Object? targetId = null,Object? timestamp = null,Object? metadata = freezed,Object? description = freezed,Object? userDisplayName = freezed,}) {
