...
mixin _$ListItem {
 ...
 String get id; String get name; int get quantity; bool get isPurchased; String? get notes; String? get category; double? get estimatedPrice; DateTime? get purchasedAt; String? get purchasedBy;
...
@useResult
$Res call({
 String id, String name, int quantity, bool isPurchased, String? notes, String? category, double? estimatedPrice, DateTime? purchasedAt, String? purchasedBy
});
...
/// Create a copy of ListItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? quantity = null,Object? isPurchased = null,Object? notes = freezed,Object? category = freezed,Object? estimatedPrice = freezed,Object? purchasedAt = freezed,Object? purchasedBy = freezed,}) {
...
as double?,purchasedAt: freezed == purchasedAt ? _self.purchasedAt : purchasedAt // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  int quantity,  bool isPurchased,  String? notes,  String? category,  double? estimatedPrice,  DateTime? purchasedAt,  String? purchasedBy)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ListItem() when $default != null:
return $default(_that.id,_that.name,_that.quantity,_that.isPurchased,_that.notes,_that.category,_that.estimatedPrice,_that.purchasedAt,_that.purchasedBy);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  int quantity,  bool isPurchased,  String? notes,  String? category,  double? estimatedPrice,  DateTime? purchasedAt,  String? purchasedBy)  $default,) {final _that = this;
switch (_that) {
case _ListItem():
return $default(_that.id,_that.name,_that.quantity,_that.isPurchased,_that.notes,_that.category,_that.estimatedPrice,_that.purchasedAt,_that.purchasedBy);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  int quantity,  bool isPurchased,  String? notes,  String? category,  double? estimatedPrice,  DateTime? purchasedAt,  String? purchasedBy)?  $default,) {final _that = this;
switch (_that) {
case _ListItem() when $default != null:
return $default(_that.id,_that.name,_that.quantity,_that.isPurchased,_that.notes,_that.category,_that.estimatedPrice,_that.purchasedAt,_that.purchasedBy);case _:
  return null;
...
class _ListItem implements ListItem {
  const _ListItem({required this.id, required this.name, required this.quantity, required this.isPurchased, this.notes, this.category, this.estimatedPrice, this.purchasedAt, this.purchasedBy});
...
/// Create a copy of ListItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? quantity = null,Object? isPurchased = null,Object? notes = freezed,Object? category = freezed,Object? estimatedPrice = freezed,Object? purchasedAt = freezed,Object? purchasedBy = freezed,}) {
