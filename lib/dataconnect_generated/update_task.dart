...
class UpdateTaskVariablesBuilder {
  ...
  UpdateTaskVariablesBuilder(
    this._dataConnect, {
    required this.id,
  });
  Deserializer<UpdateTaskData> dataDeserializer =
      (dynamic json) => UpdateTaskData.fromJson(jsonDecode(json));
  Serializer<UpdateTaskVariables> varsSerializer =
      (UpdateTaskVariables vars) => jsonEncode(vars.toJson());
  ...
  MutationRef<UpdateTaskData, UpdateTaskVariables> ref() {
    ...
    return _dataConnect.mutation(
        "UpdateTask", dataDeserializer, varsSerializer, vars);
  }
}
...
class UpdateTaskVariables {
  ...
  UpdateTaskVariables.fromJson(Map<String, dynamic> json)
    ...
    title.value =
        json['title'] == null ? null : nativeFromJson<String>(json['title']);
    ...
    status.value =
        json['status'] == null ? null : nativeFromJson<String>(json['status']);
  }
