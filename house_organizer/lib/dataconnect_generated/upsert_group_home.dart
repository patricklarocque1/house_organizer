...
class UpsertGroupHomeVariablesBuilder {
  ...
  final FirebaseDataConnect _dataConnect;  UpsertGroupHomeVariablesBuilder address(String? t) {
   _address.value = t;
   return this;
  }
  ...
  UpsertGroupHomeVariablesBuilder(this._dataConnect, {required  this.id,required  this.name,required  this.adminUserId,required  this.createdAt,});
  Deserializer<UpsertGroupHomeData> dataDeserializer = (dynamic json)  => UpsertGroupHomeData.fromJson(jsonDecode(json));
  Serializer<UpsertGroupHomeVariables> varsSerializer = (UpsertGroupHomeVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<UpsertGroupHomeData, UpsertGroupHomeVariables>> execute() {
    return ref().execute();
  }

  MutationRef<UpsertGroupHomeData, UpsertGroupHomeVariables> ref() {
    UpsertGroupHomeVariables vars= UpsertGroupHomeVariables(id: id,name: name,adminUserId: adminUserId,createdAt: createdAt,address: _address,description: _description,);
    return _dataConnect.mutation("UpsertGroupHome", dataDeserializer, varsSerializer, vars);
  }
}
...
class UpsertGroupHomeData {
  ...
  groupHome_upsert = UpsertGroupHomeGroupHomeUpsert.fromJson(json['groupHome_upsert']);
