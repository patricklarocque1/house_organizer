...
class UpsertUserVariablesBuilder {
  ...
  final FirebaseDataConnect _dataConnect;  UpsertUserVariablesBuilder photoUrl(String? t) {
   _photoUrl.value = t;
   return this;
  }

  UpsertUserVariablesBuilder(this._dataConnect, {required  this.id,required  this.displayName,required  this.email,required  this.role,required  this.createdAt,});
  ...
  MutationRef<UpsertUserData, UpsertUserVariables> ref() {
    UpsertUserVariables vars= UpsertUserVariables(id: id,displayName: displayName,email: email,role: role,createdAt: createdAt,photoUrl: _photoUrl,);
